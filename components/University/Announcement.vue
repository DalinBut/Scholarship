<template>
    <div>
      <button class="ml-4 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mt-5" type="button" v-on:click="toggleModal()">
        Add New ➕
      </button>
            ...
            <div class="mb-4 flex">
                <form @submit.prevent="submitForm" class="w-full max-w-lg">
                    ...
                    <div class="flex justify-end">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2" @click="toggleModal()">Close</button>
