    ...
    <div class="h-screen flex">
      ...
      <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
        <div class="w-full px-8 md:px-32 lg:px-24">
          <form @submit.prevent="login" class="bg-white rounded-md shadow-2xl p-5">
            ...
            <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
              ...
              <input v-model="email" id="email" class="pl-2 w-full outline-none border-none" type="email" name="email"
            ...
            <div class="flex items-center border-2 mb-12 py-2 px-3 rounded-2xl">
              ...
              <input v-model="password" class="pl-2 w-full outline-none border-none" type="password" name="password" id="password"
